...
onMounted(async () => {                                                                                                                       
  ...
  try {                                                                                                                                       
    product.value = await productService.getProductByUuid(productId);                                                                         
  } catch (error) {
    ...
    <div class="container mx-auto px-4 py-8">                                                                                                 
      ...
      <div v-else-if="product" class="max-w-4xl mx-auto">                                                                                     
        <Card class="bg-[#ffffff11] backdrop-blur border border-[#ffffff22]">                                                                 
          <template #title>                                                                                                                   
            <h1 class="text-3xl font-bold text-white">{{ t('pages_order_title') }}</h1>                                                       
          </template>                                                                                                                         
          ...
          <template #content>                                                                                                                 
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">                                                                               
              ...
              <div class="flex justify-center items-start">                                                                                   
                <img :src="product.image" :alt="product.name" class="rounded-lg max-w-full h-auto" />                                         
              </div>                                                                                                                          
              ...
              <div class="space-y-6">                                                                                                         
                ...
                <div>                                                                                                                         
                  <label class="block text-white mb-2 font-semibold">{{ t('pages_order_quantity') }}</label>                                  
                  <InputNumber                                                                                                                
                    v-model="quantity"                                                                                                        
                    :min="1"                                                                                                                  
                    :max="99"                                                                                                                 
