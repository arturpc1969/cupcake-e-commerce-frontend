...
const validateForm = () => {
  ...
  if (!formData.value.name || formData.value.name.trim() === "") {
    errors.value.name = t("pages_staff_products_new_error-name-required");
  }

  if (!formData.value.description || formData.value.description.trim() === "") {
    errors.value.description = t(
      "pages_staff_products_new_error-description-required"
    );
  }

  if (!formData.value.price || formData.value.price <= 0) {
    errors.value.price = t("pages_staff_products_new_error-price-required");
  }

  if (!formData.value.image) {
    errors.value.image = t("pages_staff_products_new_error-image-required");
  }
...
const handleImageSelect = (event) => {
  ...
  if (file) {
    ...
    if (!file.type.startsWith("image/")) {
      errors.value.image = t("pages_staff_products_new_error-image-invalid");
      return;
    }

    // Validar tamanho (máximo 5MB)
    if (file.size > 5 * 1024 * 1024) {
      errors.value.image = t("pages_staff_products_new_error-image-size");
      return;
    }
...
const saveProduct = async () => {
  if (!validateForm()) {
    toast.add({
      severity: "error",
      summary: t("pages_staff_products_new_validation-error"),
      detail: t("pages_staff_products_new_validation-error-message"),
      life: 3000,
    });
    return;
  }
  ...
  try {
    ...
    toast.add({
      severity: "success",
      summary: t("pages_staff_products_new_success"),
      detail: t("pages_staff_products_new_success-message"),
      life: 3000,
    });
    ...
    toast.add({
      severity: "error",
      summary: t("pages_staff_products_new_error"),
      detail: t("pages_staff_products_new_error-message"),
      life: 3000,
    });
  } finally {
    loading.value = false;
        ...
        <div class="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 class="text-3xl font-bold text-white">
              {{ t("pages_staff_products_new_title") }}
            </h1>
            <p class="text-gray-300 text-sm mt-1">
              {{ t("pages_staff_products_new_subtitle") }}
            </p>
          </div>
        </div>
          ...
          <form @submit.prevent="saveProduct">
            ...
            <div class="mb-6">
              <label class="block text-white font-semibold mb-2">
                {{ t("pages_staff_products_new_name") }}
                <span class="text-red-400">*</span>
              </label>
              <input
                v-model="formData.name"
                type="text"
                :placeholder="t('pages_staff_products_new_name-placeholder')"
            ...
            <div class="mb-6">
              <label class="block text-white font-semibold mb-2">
                {{ t("pages_staff_products_new_description") }}
                <span class="text-red-400">*</span>
              </label>
              <textarea
                ...
                rows="4"
                :placeholder="
                  t('pages_staff_products_new_description-placeholder')
                "
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                <label class="block text-white font-semibold mb-2">
                  {{ t("pages_staff_products_new_price") }}
                  <span class="text-red-400">*</span>
                </label>
                <div class="relative">
                  <span
                  ...
                  <input
                    ...
                    min="0"
                    :placeholder="
                      t('pages_staff_products_new_price-placeholder')
                    "
              ...
              <div>
                <label class="block text-white font-semibold mb-2">
                  {{ t("pages_staff_products_new_promotion") }}
                </label>
                <div
                ...
                >
                  <label class="flex items-center cursor-pointer">
                    ...
                    <span class="ml-3 text-gray-300">
                      {{
                        t("pages_staff_products_new_promotion-checkbox-label")
                      }}
                    </span>
                  </label>
                </div>
            ...
            <div class="mb-8">
              <label class="block text-white font-semibold mb-2">
                {{ t("pages_staff_products_new_image") }}
                <span class="text-red-400">*</span>
              </label>
              ...
              >
                ...
                <p class="text-white mb-2">
                  {{ t("pages_staff_products_new_image-upload") }}
                </p>
                <p class="text-gray-400 text-sm">
                  {{ t("pages_staff_products_new_image-formats") }}
                </p>
              </div>
            ...
            >
              ...
              <p class="text-sm">
                {{ t("pages_staff_products_new_info") }}
              </p>
            </div>
            ...
            <div class="flex gap-4">
              <button
                ...
                @click="cancel"
              >
                {{ t("pages_staff_products_new_cancel") }}
              </button>
              <button
                type="submit"
              ...
              >
                ...
                <span v-if="loading">
                  {{ t("pages_staff_products_new_saving") }}
                </span>
                <span v-else>
                  {{ t("pages_staff_products_new_save") }}
                </span>
              </button>
            </div>
          </form>
