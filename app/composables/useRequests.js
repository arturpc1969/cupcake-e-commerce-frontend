...
export const useRequests = () => {
    ...
    const getAuthToken = async () => {                                                                                                                                        
        ...
        try {                                                                                                                                                                 
            ...
            console.log(t('composables_use-requests_get-auth-token_use-auth-access-error'), error)                                                                                                                                                     
        ...
        try {
            ...
            if (error.response?.status === 401 && requiresAuth) {                                                                                                             
                ...
                try {                                                                                                                                                         
                    ...
                    console.log(t('composables_use-requests_make-request_use-auth-access-in-logout-error'), e)                                                                                                                                               
